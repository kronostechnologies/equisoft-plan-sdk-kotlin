package com.equisoft.plan.sdk.infrastructure
...
open class ApiClient(
    ...
    companion object {
        ...
        const val baseUrlKey = "com.equisoft.plan.sdk.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val f = java.nio.file.Files.createTempFile("tmp.com.equisoft.plan.sdk", null).toFile()
            f.deleteOnExit()
